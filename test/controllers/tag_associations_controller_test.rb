...
class TagAssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tag_association" do
    assert_difference('TagAssociation.count') do
      post tag_associations_url, params: { tag_association: { tag_id: @tag_association.tag_id, task_id: @tag_association.task_id } }
    end
  ...
  test "should update tag_association" do
    patch tag_association_url(@tag_association), params: { tag_association: { tag_id: @tag_association.tag_id, task_id: @tag_association.task_id } }
